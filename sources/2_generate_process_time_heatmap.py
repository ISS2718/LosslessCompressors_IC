...
data_in = '../results/1_compressors_accuracy/RESULTS'
data_out = "../results/2_generate_process_time_heatmap"
...
for load in os.listdir(data_in):
    ...
    df = remove_compressor_from_df(['BZIP2', 'LZMA','WEBP_LOSSY', 'JP2_LOSSY', 'HEIF'], df)
